...
const cloneScheduleMatrix = (matrix: ScheduleMatrix): ScheduleMatrix => ({
  ...
  Consulado: {
    ...
    employees: [...matrix.Consulado.empleados],
  },
})
  ...
  const handleSlotChange = (positionId: string, value: string) => {
    ...
    let updated = false
    let notification: { title: string; description: string; variant?: "destructive" } | null = null
                  ...
                  >
                    ...
                    {role.notes.trim() ? (
                      <div className="rounded-lg border border-dashed border-slate-200 bg-slate-50 p-3">
                        ...
                        <p className="text-sm text-slate-700">{role.notes}</p>
                      </div>
                    ) : null}
                  </div>
                ))}
